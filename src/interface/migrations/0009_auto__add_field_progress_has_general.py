...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Progress.has_general'
        db.add_column(u'interface_progress', 'has_general',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Progress.has_general'
        db.delete_column(u'interface_progress', 'has_general')
