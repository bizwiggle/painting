...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Progress.business_name'
        db.add_column(u'interface_progress', 'business_name',
                      self.gf('django.db.models.fields.CharField')(default='Your Business Name', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Progress.business_name'
        db.delete_column(u'interface_progress', 'business_name')
