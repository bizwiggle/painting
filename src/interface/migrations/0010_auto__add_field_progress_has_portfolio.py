...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Progress.has_portfolio'
        db.add_column(u'interface_progress', 'has_portfolio',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Progress.has_portfolio'
        db.delete_column(u'interface_progress', 'has_portfolio')
