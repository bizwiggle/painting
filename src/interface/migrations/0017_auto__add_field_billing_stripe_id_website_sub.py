...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Billing.stripe_id_website_sub'
        db.add_column(u'interface_billing', 'stripe_id_website_sub',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Billing.stripe_id_website_sub'
        db.delete_column(u'interface_billing', 'stripe_id_website_sub')
    ...
    models = {
        ...
        u'interface.billing': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'shutoff_service_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
