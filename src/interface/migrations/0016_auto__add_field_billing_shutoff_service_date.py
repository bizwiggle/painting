...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Billing.shutoff_service_date'
        db.add_column(u'interface_billing', 'shutoff_service_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Billing.shutoff_service_date'
        db.delete_column(u'interface_billing', 'shutoff_service_date')
