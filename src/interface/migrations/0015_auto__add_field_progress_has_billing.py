...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Progress.has_billing'
        db.add_column(u'interface_progress', 'has_billing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Progress.has_billing'
        db.delete_column(u'interface_progress', 'has_billing')
