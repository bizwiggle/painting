...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pages_services', (
            ...
            ('residential_pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ('comercial_blurb', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('comercial_pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ('other_services_blurb', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('other_services_pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ('service_area_blurb', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
    ...
    models = {
        ...
        u'pages.services': {
            ...
            'comercial_pic': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'other_services_blurb': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'other_services_pic': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
            'residential_blurb': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'residential_pic': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
