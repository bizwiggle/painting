...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'General_Info.logo'
        db.alter_column(u'pages_general_info', 'logo', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'General_Info.logo'
        db.alter_column(u'pages_general_info', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
