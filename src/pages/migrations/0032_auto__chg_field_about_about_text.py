...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'About.about_text'
        db.alter_column(u'pages_about', 'about_text', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'About.about_text'
        db.alter_column(u'pages_about', 'about_text', self.gf('django.db.models.fields.CharField')(max_length=64))
