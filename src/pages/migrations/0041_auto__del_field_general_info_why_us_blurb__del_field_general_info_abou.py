...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Index.why_us_blurb'
        db.add_column(u'pages_index', 'why_us_blurb',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True),
                      keep_default=False)

        # Adding field 'Index.about_blurb'
        db.add_column(u'pages_index', 'about_blurb',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Index.why_us_blurb'
        db.delete_column(u'pages_index', 'why_us_blurb')

        # Deleting field 'Index.about_blurb'
        db.delete_column(u'pages_index', 'about_blurb')
