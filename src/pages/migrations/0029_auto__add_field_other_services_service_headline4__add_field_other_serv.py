...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Other_Services.service_headline4'
        db.add_column(u'pages_other_services', 'service_headline4',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Other_Services.service4'
        db.add_column(u'pages_other_services', 'service4',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'Other_Services.service_headline5'
        db.add_column(u'pages_other_services', 'service_headline5',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Other_Services.service5'
        db.add_column(u'pages_other_services', 'service5',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Other_Services.service_headline4'
        db.delete_column(u'pages_other_services', 'service_headline4')

        # Deleting field 'Other_Services.service4'
        db.delete_column(u'pages_other_services', 'service4')

        # Deleting field 'Other_Services.service_headline5'
        db.delete_column(u'pages_other_services', 'service_headline5')

        # Deleting field 'Other_Services.service5'
        db.delete_column(u'pages_other_services', 'service5')
