...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Index.slider_txt_top1'
        db.add_column(u'pages_index', 'slider_txt_top1',
                      self.gf('django.db.models.fields.CharField')(default='Request a', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Index.slider_txt_bottom1'
        db.add_column(u'pages_index', 'slider_txt_bottom1',
                      self.gf('django.db.models.fields.CharField')(default='Hassle Free Estimate', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Index.slider_link1'
        db.add_column(u'pages_index', 'slider_link1',
                      self.gf('django.db.models.fields.CharField')(default='Contact', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Index.slider_txt_top1'
        db.delete_column(u'pages_index', 'slider_txt_top1')

        # Deleting field 'Index.slider_txt_bottom1'
        db.delete_column(u'pages_index', 'slider_txt_bottom1')

        # Deleting field 'Index.slider_link1'
        db.delete_column(u'pages_index', 'slider_link1')
