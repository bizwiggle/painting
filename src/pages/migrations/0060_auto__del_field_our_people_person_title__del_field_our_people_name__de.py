...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Our_People.person_title'
        db.delete_column(u'pages_our_people', 'person_title')

        # Deleting field 'Our_People.name'
        db.delete_column(u'pages_our_people', 'name')

        # Deleting field 'Our_People.text'
        db.delete_column(u'pages_our_people', 'text')

        # Deleting field 'Our_People.pic'
        db.delete_column(u'pages_our_people', 'pic')
        ...
        # Adding field 'Our_People.text1'
        db.add_column(u'pages_our_people', 'text1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.pic1'
        db.add_column(u'pages_our_people', 'pic1',
        ...
        # Adding field 'Our_People.text2'
        db.add_column(u'pages_our_people', 'text2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.pic2'
        db.add_column(u'pages_our_people', 'pic2',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Our_People.text3'
        db.add_column(u'pages_our_people', 'text3',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.pic3'
        db.add_column(u'pages_our_people', 'pic3',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Our_People.text4'
        db.add_column(u'pages_our_people', 'text4',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.pic4'
        db.add_column(u'pages_our_people', 'pic4',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Our_People.text5'
        db.add_column(u'pages_our_people', 'text5',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.pic5'
        db.add_column(u'pages_our_people', 'pic5',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Our_People.text6'
        db.add_column(u'pages_our_people', 'text6',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.pic6'
        db.add_column(u'pages_our_people', 'pic6',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Our_People.text7'
        db.add_column(u'pages_our_people', 'text7',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.pic7'
        db.add_column(u'pages_our_people', 'pic7',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Our_People.person_title8'
        db.add_column(u'pages_our_people', 'person_title8',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=48, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.text8'
        db.add_column(u'pages_our_people', 'text8',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.pic8'
        db.add_column(u'pages_our_people', 'pic8',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Our_People.text9'
        db.add_column(u'pages_our_people', 'text9',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.pic9'
        db.add_column(u'pages_our_people', 'pic9',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Our_People.text10'
        db.add_column(u'pages_our_people', 'text10',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.pic10'
        db.add_column(u'pages_our_people', 'pic10',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Our_People.person_title'
        db.add_column(u'pages_our_people', 'person_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=48, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.name'
        db.add_column(u'pages_our_people', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=48, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.text'
        db.add_column(u'pages_our_people', 'text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.pic'
        db.add_column(u'pages_our_people', 'pic',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Our_People.text1'
        db.delete_column(u'pages_our_people', 'text1')

        # Deleting field 'Our_People.pic1'
        db.delete_column(u'pages_our_people', 'pic1')
        ...
        # Deleting field 'Our_People.text2'
        db.delete_column(u'pages_our_people', 'text2')

        # Deleting field 'Our_People.pic2'
        db.delete_column(u'pages_our_people', 'pic2')
        ...
        # Deleting field 'Our_People.text3'
        db.delete_column(u'pages_our_people', 'text3')

        # Deleting field 'Our_People.pic3'
        db.delete_column(u'pages_our_people', 'pic3')
        ...
        # Deleting field 'Our_People.text4'
        db.delete_column(u'pages_our_people', 'text4')

        # Deleting field 'Our_People.pic4'
        db.delete_column(u'pages_our_people', 'pic4')
        ...
        # Deleting field 'Our_People.text5'
        db.delete_column(u'pages_our_people', 'text5')

        # Deleting field 'Our_People.pic5'
        db.delete_column(u'pages_our_people', 'pic5')
        ...
        # Deleting field 'Our_People.text6'
        db.delete_column(u'pages_our_people', 'text6')

        # Deleting field 'Our_People.pic6'
        db.delete_column(u'pages_our_people', 'pic6')
        ...
        # Deleting field 'Our_People.text7'
        db.delete_column(u'pages_our_people', 'text7')

        # Deleting field 'Our_People.pic7'
        db.delete_column(u'pages_our_people', 'pic7')

        # Deleting field 'Our_People.name8'
        db.delete_column(u'pages_our_people', 'name8')

        # Deleting field 'Our_People.person_title8'
        db.delete_column(u'pages_our_people', 'person_title8')

        # Deleting field 'Our_People.text8'
        db.delete_column(u'pages_our_people', 'text8')

        # Deleting field 'Our_People.pic8'
        db.delete_column(u'pages_our_people', 'pic8')
        ...
        # Deleting field 'Our_People.text9'
        db.delete_column(u'pages_our_people', 'text9')

        # Deleting field 'Our_People.pic9'
        db.delete_column(u'pages_our_people', 'pic9')
        ...
        # Deleting field 'Our_People.text10'
        db.delete_column(u'pages_our_people', 'text10')

        # Deleting field 'Our_People.pic10'
        db.delete_column(u'pages_our_people', 'pic10')
    ...
    models = {
        ...
        u'pages.our_people': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'name1': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'name10': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'name2': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'name3': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'name4': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'name5': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'name6': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'name7': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'name8': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'name9': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'person_title1': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'person_title10': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'person_title2': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'person_title3': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'person_title4': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'person_title5': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'person_title6': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'person_title7': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'person_title8': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'person_title9': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'pic1': ('imagekit.models.fields.ProcessedImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
