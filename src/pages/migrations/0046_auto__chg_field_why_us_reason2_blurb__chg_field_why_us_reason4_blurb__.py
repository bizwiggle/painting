...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Why_Us.reason2_blurb'
        db.alter_column(u'pages_why_us', 'reason2_blurb', self.gf('django.db.models.fields.CharField')(max_length=350))

        # Changing field 'Why_Us.reason4_blurb'
        db.alter_column(u'pages_why_us', 'reason4_blurb', self.gf('django.db.models.fields.CharField')(max_length=350))

        # Changing field 'Why_Us.reason3_blurb'
        db.alter_column(u'pages_why_us', 'reason3_blurb', self.gf('django.db.models.fields.CharField')(max_length=350))

        # Changing field 'Why_Us.reason5_blurb'
        db.alter_column(u'pages_why_us', 'reason5_blurb', self.gf('django.db.models.fields.CharField')(max_length=350))

        # Changing field 'Why_Us.reason1_blurb'
        db.alter_column(u'pages_why_us', 'reason1_blurb', self.gf('django.db.models.fields.CharField')(max_length=350))

    def backwards(self, orm):

        # Changing field 'Why_Us.reason2_blurb'
        db.alter_column(u'pages_why_us', 'reason2_blurb', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Why_Us.reason4_blurb'
        db.alter_column(u'pages_why_us', 'reason4_blurb', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Why_Us.reason3_blurb'
        db.alter_column(u'pages_why_us', 'reason3_blurb', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Why_Us.reason5_blurb'
        db.alter_column(u'pages_why_us', 'reason5_blurb', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Why_Us.reason1_blurb'
        db.alter_column(u'pages_why_us', 'reason1_blurb', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        u'pages.general_info': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 21, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
