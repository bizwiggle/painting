...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Index.slider_txt_top2'
        db.add_column(u'pages_index', 'slider_txt_top2',
                      self.gf('django.db.models.fields.CharField')(default='Request a', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Index.slider_txt_bottom2'
        db.add_column(u'pages_index', 'slider_txt_bottom2',
                      self.gf('django.db.models.fields.CharField')(default='Hassle Free Estimate', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Index.slider_link2'
        db.add_column(u'pages_index', 'slider_link2',
                      self.gf('django.db.models.fields.CharField')(default='Contact', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Index.slider_txt_top3'
        db.add_column(u'pages_index', 'slider_txt_top3',
                      self.gf('django.db.models.fields.CharField')(default='Request a', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Index.slider_txt_bottom3'
        db.add_column(u'pages_index', 'slider_txt_bottom3',
                      self.gf('django.db.models.fields.CharField')(default='Hassle Free Estimate', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Index.slider_link3'
        db.add_column(u'pages_index', 'slider_link3',
                      self.gf('django.db.models.fields.CharField')(default='Contact', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Index.slider_txt_top4'
        db.add_column(u'pages_index', 'slider_txt_top4',
                      self.gf('django.db.models.fields.CharField')(default='Request a', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Index.slider_txt_bottom4'
        db.add_column(u'pages_index', 'slider_txt_bottom4',
                      self.gf('django.db.models.fields.CharField')(default='Hassle Free Estimate', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Index.slider_link4'
        db.add_column(u'pages_index', 'slider_link4',
                      self.gf('django.db.models.fields.CharField')(default='Contact', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Index.slider_txt_top5'
        db.add_column(u'pages_index', 'slider_txt_top5',
                      self.gf('django.db.models.fields.CharField')(default='Request a', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Index.slider_txt_bottom5'
        db.add_column(u'pages_index', 'slider_txt_bottom5',
                      self.gf('django.db.models.fields.CharField')(default='Hassle Free Estimate', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Index.slider_link5'
        db.add_column(u'pages_index', 'slider_link5',
                      self.gf('django.db.models.fields.CharField')(default='Contact', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Index.slider_txt_top2'
        db.delete_column(u'pages_index', 'slider_txt_top2')

        # Deleting field 'Index.slider_txt_bottom2'
        db.delete_column(u'pages_index', 'slider_txt_bottom2')

        # Deleting field 'Index.slider_link2'
        db.delete_column(u'pages_index', 'slider_link2')

        # Deleting field 'Index.slider_txt_top3'
        db.delete_column(u'pages_index', 'slider_txt_top3')

        # Deleting field 'Index.slider_txt_bottom3'
        db.delete_column(u'pages_index', 'slider_txt_bottom3')

        # Deleting field 'Index.slider_link3'
        db.delete_column(u'pages_index', 'slider_link3')

        # Deleting field 'Index.slider_txt_top4'
        db.delete_column(u'pages_index', 'slider_txt_top4')

        # Deleting field 'Index.slider_txt_bottom4'
        db.delete_column(u'pages_index', 'slider_txt_bottom4')

        # Deleting field 'Index.slider_link4'
        db.delete_column(u'pages_index', 'slider_link4')

        # Deleting field 'Index.slider_txt_top5'
        db.delete_column(u'pages_index', 'slider_txt_top5')

        # Deleting field 'Index.slider_txt_bottom5'
        db.delete_column(u'pages_index', 'slider_txt_bottom5')

        # Deleting field 'Index.slider_link5'
        db.delete_column(u'pages_index', 'slider_link5')
