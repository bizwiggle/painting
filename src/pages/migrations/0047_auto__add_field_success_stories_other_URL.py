...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Success_Stories.other_URL'
        db.add_column(u'pages_success_stories', 'other_URL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Success_Stories.other_URL'
        db.delete_column(u'pages_success_stories', 'other_URL')
