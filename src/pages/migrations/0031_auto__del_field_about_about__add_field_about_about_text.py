...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'About.about'
        db.delete_column(u'pages_about', 'about')

        # Adding field 'About.about_text'
        db.add_column(u'pages_about', 'about_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'About.about'
        db.add_column(u'pages_about', 'about',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Deleting field 'About.about_text'
        db.delete_column(u'pages_about', 'about_text')
    ...
    models = {
        ...
        u'pages.about': {
            ...
            'about_text': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
