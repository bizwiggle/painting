...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'General_Info.change'
        db.add_column(u'pages_general_info', 'change',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=17, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'General_Info.change'
        db.delete_column(u'pages_general_info', 'change')
