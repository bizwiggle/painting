...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Index.affilation1_URL'
        db.add_column(u'pages_index', 'affilation1_URL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Index.affilation2_URL'
        db.add_column(u'pages_index', 'affilation2_URL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Index.affilation3_URL'
        db.add_column(u'pages_index', 'affilation3_URL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Index.affilation4_URL'
        db.add_column(u'pages_index', 'affilation4_URL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Index.affilation5_URL'
        db.add_column(u'pages_index', 'affilation5_URL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Index.affilation6_URL'
        db.add_column(u'pages_index', 'affilation6_URL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Index.affilation1_URL'
        db.delete_column(u'pages_index', 'affilation1_URL')

        # Deleting field 'Index.affilation2_URL'
        db.delete_column(u'pages_index', 'affilation2_URL')

        # Deleting field 'Index.affilation3_URL'
        db.delete_column(u'pages_index', 'affilation3_URL')

        # Deleting field 'Index.affilation4_URL'
        db.delete_column(u'pages_index', 'affilation4_URL')

        # Deleting field 'Index.affilation5_URL'
        db.delete_column(u'pages_index', 'affilation5_URL')

        # Deleting field 'Index.affilation6_URL'
        db.delete_column(u'pages_index', 'affilation6_URL')
    ...
    models = {
        ...
        u'pages.about': {
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 8, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
