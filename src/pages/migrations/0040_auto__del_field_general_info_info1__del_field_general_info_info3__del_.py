...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'General_Info.info1'
        db.delete_column(u'pages_general_info', 'info1')

        # Deleting field 'General_Info.info3'
        db.delete_column(u'pages_general_info', 'info3')

        # Deleting field 'General_Info.info2'
        db.delete_column(u'pages_general_info', 'info2')

        # Deleting field 'General_Info.info5'
        db.delete_column(u'pages_general_info', 'info5')

        # Deleting field 'General_Info.info4'
        db.delete_column(u'pages_general_info', 'info4')

        # Deleting field 'General_Info.info_headline'
        db.delete_column(u'pages_general_info', 'info_headline')

        # Adding field 'General_Info.why_us_blurb'
        db.add_column(u'pages_general_info', 'why_us_blurb',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True),
                      keep_default=False)

        # Adding field 'General_Info.about_blurb'
        db.add_column(u'pages_general_info', 'about_blurb',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True),
                      keep_default=False)

        # Adding field 'About.info_headline'
        db.add_column(u'pages_about', 'info_headline',
                      self.gf('django.db.models.fields.CharField')(default='The Bottom Line', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'About.info1'
        db.add_column(u'pages_about', 'info1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'About.info2'
        db.add_column(u'pages_about', 'info2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'About.info3'
        db.add_column(u'pages_about', 'info3',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'About.info4'
        db.add_column(u'pages_about', 'info4',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'About.info5'
        db.add_column(u'pages_about', 'info5',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'General_Info.info1'
        db.add_column(u'pages_general_info', 'info1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'General_Info.info3'
        db.add_column(u'pages_general_info', 'info3',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'General_Info.info2'
        db.add_column(u'pages_general_info', 'info2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'General_Info.info5'
        db.add_column(u'pages_general_info', 'info5',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'General_Info.info4'
        db.add_column(u'pages_general_info', 'info4',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'General_Info.info_headline'
        db.add_column(u'pages_general_info', 'info_headline',
                      self.gf('django.db.models.fields.CharField')(default='The Bottom Line', max_length=32, blank=True),
                      keep_default=False)

        # Deleting field 'General_Info.why_us_blurb'
        db.delete_column(u'pages_general_info', 'why_us_blurb')

        # Deleting field 'General_Info.about_blurb'
        db.delete_column(u'pages_general_info', 'about_blurb')

        # Deleting field 'About.info_headline'
        db.delete_column(u'pages_about', 'info_headline')

        # Deleting field 'About.info1'
        db.delete_column(u'pages_about', 'info1')

        # Deleting field 'About.info2'
        db.delete_column(u'pages_about', 'info2')

        # Deleting field 'About.info3'
        db.delete_column(u'pages_about', 'info3')

        # Deleting field 'About.info4'
        db.delete_column(u'pages_about', 'info4')

        # Deleting field 'About.info5'
        db.delete_column(u'pages_about', 'info5')
    ...
    models = {
        ...
        u'pages.about': {
            ...
            'about_headline': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            'about_text': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'pages.comercial_service': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'use_default_pic1': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'use_default_pic2': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'use_default_pic3': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.MyUser']"})
        },
        u'pages.general_info': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'pages.other_services': {
            ...
            'use_default_pic2': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'use_default_pic3': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'use_default_pic4': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'use_default_pic5': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.MyUser']"})
        },
        u'pages.our_people': {
