...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Our_People.headline'
        db.delete_column(u'pages_our_people', 'headline')
        ...
        # Adding field 'Our_People.title'
        db.add_column(u'pages_our_people', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=48, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Our_People.headline'
        db.add_column(u'pages_our_people', 'headline',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=48, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Our_People.title'
        db.delete_column(u'pages_our_people', 'title')
    ...
    models = {
        ...
        u'pages.about': {
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'pages.our_people': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'pic': ('imagekit.models.fields.ProcessedImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
