...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'pages.comercial_service': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'use_default_pic1': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'use_default_pic2': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'use_default_pic3': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.MyUser']"})
        },
        ...
        u'pages.other_services': {
            ...
            'use_default_pic2': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'use_default_pic3': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'use_default_pic4': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'use_default_pic5': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.MyUser']"})
        },
        u'pages.our_people': {
