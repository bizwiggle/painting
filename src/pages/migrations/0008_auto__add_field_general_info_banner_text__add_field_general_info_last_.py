...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'General_Info.banner_text'
        db.add_column(u'pages_general_info', 'banner_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)

        # Adding field 'General_Info.last_modified'
        db.add_column(u'pages_general_info', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 8, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Social.facebook_URL'
        db.add_column(u'pages_social', 'facebook_URL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Social.linkedin_URL'
        db.add_column(u'pages_social', 'linkedin_URL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Social.google_plus_URL'
        db.add_column(u'pages_social', 'google_plus_URL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Social.twitter_URL'
        db.add_column(u'pages_social', 'twitter_URL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Social.pintrest_URL'
        db.add_column(u'pages_social', 'pintrest_URL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'General_Info.banner_text'
        db.delete_column(u'pages_general_info', 'banner_text')

        # Deleting field 'General_Info.last_modified'
        db.delete_column(u'pages_general_info', 'last_modified')

        # Deleting field 'Social.facebook_URL'
        db.delete_column(u'pages_social', 'facebook_URL')

        # Deleting field 'Social.linkedin_URL'
        db.delete_column(u'pages_social', 'linkedin_URL')

        # Deleting field 'Social.google_plus_URL'
        db.delete_column(u'pages_social', 'google_plus_URL')

        # Deleting field 'Social.twitter_URL'
        db.delete_column(u'pages_social', 'twitter_URL')

        # Deleting field 'Social.pintrest_URL'
        db.delete_column(u'pages_social', 'pintrest_URL')
