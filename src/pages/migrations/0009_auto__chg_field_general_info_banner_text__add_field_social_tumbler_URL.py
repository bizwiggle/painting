...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'General_Info.banner_text'
        db.alter_column(u'pages_general_info', 'banner_text', self.gf('django.db.models.fields.CharField')(max_length=90))
        # Adding field 'Social.tumbler_URL'
        db.add_column(u'pages_social', 'tumbler_URL',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'General_Info.banner_text'
        db.alter_column(u'pages_general_info', 'banner_text', self.gf('django.db.models.fields.CharField')(max_length=120))
        # Deleting field 'Social.tumbler_URL'
        db.delete_column(u'pages_social', 'tumbler_URL')
    ...
    models = {
        ...
        u'pages.social': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'tumbler_URL': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
