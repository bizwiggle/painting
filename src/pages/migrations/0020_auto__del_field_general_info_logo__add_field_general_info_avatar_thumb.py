...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'General_Info.logo'
        db.delete_column(u'pages_general_info', 'logo')

        # Adding field 'General_Info.avatar_thumbnail'
        db.add_column(u'pages_general_info', 'avatar_thumbnail',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'General_Info.logo'
        db.add_column(u'pages_general_info', 'logo',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'General_Info.avatar_thumbnail'
        db.delete_column(u'pages_general_info', 'avatar_thumbnail')
    ...
    models = {
        ...
        u'pages.general_info': {
            ...
            'avatar_thumbnail': ('imagekit.models.fields.ProcessedImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
