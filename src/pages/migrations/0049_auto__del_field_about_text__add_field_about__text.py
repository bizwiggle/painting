...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'About._text'
        db.add_column(u'pages_about', '_text',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'About._text'
        db.delete_column(u'pages_about', '_text')
    ...
    models = {
        ...
        u'pages.about': {
            ...
            '_text': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
