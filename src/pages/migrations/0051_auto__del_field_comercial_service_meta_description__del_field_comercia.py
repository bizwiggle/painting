...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Comercial_Service.meta_description'
        db.delete_column(u'pages_comercial_service', 'meta_description')
        ...
        # Adding field 'Comercial_Service.last_modified'
        db.add_column(u'pages_comercial_service', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 28, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Our_People.last_modified'
        db.add_column(u'pages_our_people', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 28, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Portfolio_Pic.last_modified'
        db.add_column(u'pages_portfolio_pic', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 28, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Success_Stories.last_modified'
        db.add_column(u'pages_success_stories', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 28, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Deleting field 'About.meta_description'
        db.delete_column(u'pages_about', 'meta_description')

        # Adding field 'About.last_modified'
        db.add_column(u'pages_about', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 28, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Deleting field 'Why_Us.meta_description'
        db.delete_column(u'pages_why_us', 'meta_description')

        # Adding field 'Why_Us.last_modified'
        db.add_column(u'pages_why_us', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 28, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Deleting field 'Services.meta_description'
        db.delete_column(u'pages_services', 'meta_description')

        # Adding field 'Services.last_modified'
        db.add_column(u'pages_services', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 28, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Deleting field 'Index.meta_description'
        db.delete_column(u'pages_index', 'meta_description')

        # Adding field 'Index.last_modified'
        db.add_column(u'pages_index', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 28, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Deleting field 'Other_Services.meta_description'
        db.delete_column(u'pages_other_services', 'meta_description')
        ...
        # Adding field 'Other_Services.last_modified'
        db.add_column(u'pages_other_services', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 28, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Deleting field 'Residential_Service.meta_description'
        db.delete_column(u'pages_residential_service', 'meta_description')
        ...
        # Adding field 'Residential_Service.last_modified'
        db.add_column(u'pages_residential_service', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 28, 0, 0), auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Comercial_Service.meta_description'
        db.add_column(u'pages_comercial_service', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Comercial_Service.last_modified'
        db.delete_column(u'pages_comercial_service', 'last_modified')

        # Deleting field 'Our_People.last_modified'
        db.delete_column(u'pages_our_people', 'last_modified')

        # Deleting field 'Portfolio_Pic.last_modified'
        db.delete_column(u'pages_portfolio_pic', 'last_modified')

        # Deleting field 'Success_Stories.last_modified'
        db.delete_column(u'pages_success_stories', 'last_modified')

        # Adding field 'About.meta_description'
        db.add_column(u'pages_about', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True),
                      keep_default=False)

        # Deleting field 'About.last_modified'
        db.delete_column(u'pages_about', 'last_modified')

        # Adding field 'Why_Us.meta_description'
        db.add_column(u'pages_why_us', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True),
                      keep_default=False)

        # Deleting field 'Why_Us.last_modified'
        db.delete_column(u'pages_why_us', 'last_modified')

        # Adding field 'Services.meta_description'
        db.add_column(u'pages_services', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True),
                      keep_default=False)

        # Deleting field 'Services.last_modified'
        db.delete_column(u'pages_services', 'last_modified')

        # Adding field 'Index.meta_description'
        db.add_column(u'pages_index', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True),
                      keep_default=False)

        # Deleting field 'Index.last_modified'
        db.delete_column(u'pages_index', 'last_modified')

        # Adding field 'Other_Services.meta_description'
        db.add_column(u'pages_other_services', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Other_Services.last_modified'
        db.delete_column(u'pages_other_services', 'last_modified')

        # Adding field 'Residential_Service.meta_description'
        db.add_column(u'pages_residential_service', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Residential_Service.last_modified'
        db.delete_column(u'pages_residential_service', 'last_modified')
    ...
    models = {
        ...
        u'pages.about': {
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 28, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
