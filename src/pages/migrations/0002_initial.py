...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pages_general_info', (
            ...
            ('business_name', self.gf('django.db.models.fields.CharField')(default='Business Name', max_length=64, blank=True)),
            ('street_address', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('extra_address', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ...
            ('change', self.gf('django.db.models.fields.CharField')(max_length=17, blank=True)),
    ...
    models = {
        ...
        u'pages.general_info': {
            ...
            'change': ('django.db.models.fields.CharField', [], {'max_length': '17', 'blank': 'True'}),
            'city': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '64', 'blank': 'True'}),
            'extra_address': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
