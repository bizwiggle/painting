...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'General_Info.contact_meta_description'
        db.add_column(u'pages_general_info', 'contact_meta_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True),
                      keep_default=False)

        # Adding field 'General_Info.portfolio_meta_description'
        db.add_column(u'pages_general_info', 'portfolio_meta_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'General_Info.contact_meta_description'
        db.delete_column(u'pages_general_info', 'contact_meta_description')

        # Deleting field 'General_Info.portfolio_meta_description'
        db.delete_column(u'pages_general_info', 'portfolio_meta_description')
