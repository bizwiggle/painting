...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'About.about_headline'
        db.delete_column(u'pages_about', 'about_headline')

        # Deleting field 'About.about_text'
        db.delete_column(u'pages_about', 'about_text')

        # Adding field 'About.headline'
        db.add_column(u'pages_about', 'headline',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'About.text'
        db.add_column(u'pages_about', 'text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'About.about_headline'
        db.add_column(u'pages_about', 'about_headline',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'About.headline'
        db.delete_column(u'pages_about', 'headline')

        # Deleting field 'About.text'
        db.delete_column(u'pages_about', 'text')
    ...
    models = {
        ...
        u'pages.general_info': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
