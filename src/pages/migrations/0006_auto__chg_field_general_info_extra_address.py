...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'General_Info.extra_address'
        db.alter_column(u'pages_general_info', 'extra_address', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'General_Info.extra_address'
        db.alter_column(u'pages_general_info', 'extra_address', self.gf('django.db.models.fields.CharField')(max_length=64))
