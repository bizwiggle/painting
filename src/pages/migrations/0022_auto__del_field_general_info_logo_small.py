...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'General_Info.logo_small'
        db.delete_column(u'pages_general_info', 'logo_small')


    def backwards(self, orm):
        # Adding field 'General_Info.logo_small'
        db.add_column(u'pages_general_info', 'logo_small',
