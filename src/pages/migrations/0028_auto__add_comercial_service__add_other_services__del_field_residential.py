...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pages_comercial_service', (
            ...
            ('use_default_pic1', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('use_default_pic2', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('use_default_pic3', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.create_table(u'pages_other_services', (
            ...
            ('use_default_pic2', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('use_default_pic3', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('use_default_pic4', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('use_default_pic5', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('pic1', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True)),
            ('pic2', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True)),
            ('pic3', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True)),
        ...
        # Deleting field 'Residential_Service.residential_pic1'
        db.delete_column(u'pages_residential_service', 'residential_pic1')

        # Deleting field 'Residential_Service.residential_pic3'
        db.delete_column(u'pages_residential_service', 'residential_pic3')

        # Deleting field 'Residential_Service.residential_pic2'
        db.delete_column(u'pages_residential_service', 'residential_pic2')

        # Adding field 'Residential_Service.pic1'
        db.add_column(u'pages_residential_service', 'pic1',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Residential_Service.pic2'
        db.add_column(u'pages_residential_service', 'pic2',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Residential_Service.pic3'
        db.add_column(u'pages_residential_service', 'pic3',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Residential_Service.residential_pic1'
        db.add_column(u'pages_residential_service', 'residential_pic1',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Residential_Service.residential_pic3'
        db.add_column(u'pages_residential_service', 'residential_pic3',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Residential_Service.residential_pic2'
        db.add_column(u'pages_residential_service', 'residential_pic2',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Residential_Service.pic1'
        db.delete_column(u'pages_residential_service', 'pic1')

        # Deleting field 'Residential_Service.pic2'
        db.delete_column(u'pages_residential_service', 'pic2')

        # Deleting field 'Residential_Service.pic3'
        db.delete_column(u'pages_residential_service', 'pic3')
    ...
    models = {
        ...
        u'pages.general_info': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
