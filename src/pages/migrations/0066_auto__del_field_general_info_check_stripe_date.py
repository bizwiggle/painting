...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'General_Info.check_stripe_date'
        db.delete_column(u'pages_general_info', 'check_stripe_date')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'General_Info.check_stripe_date'
        raise RuntimeError("Cannot reverse this migration. 'General_Info.check_stripe_date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'General_Info.check_stripe_date'
        db.add_column(u'pages_general_info', 'check_stripe_date',
