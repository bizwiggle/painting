...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'General_Info.email'
        db.add_column(u'pages_general_info', 'email',
                      self.gf('django.db.models.fields.EmailField')(db_index=True, default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'General_Info.email'
        db.delete_column(u'pages_general_info', 'email')
