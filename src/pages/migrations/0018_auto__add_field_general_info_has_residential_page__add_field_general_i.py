...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'General_Info.has_residential_page'
        db.add_column(u'pages_general_info', 'has_residential_page',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'General_Info.has_comercial_page'
        db.add_column(u'pages_general_info', 'has_comercial_page',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'General_Info.has_other_services_page'
        db.add_column(u'pages_general_info', 'has_other_services_page',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'General_Info.has_residential_page'
        db.delete_column(u'pages_general_info', 'has_residential_page')

        # Deleting field 'General_Info.has_comercial_page'
        db.delete_column(u'pages_general_info', 'has_comercial_page')

        # Deleting field 'General_Info.has_other_services_page'
        db.delete_column(u'pages_general_info', 'has_other_services_page')
    ...
    models = {
        ...
        u'pages.general_info': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'pages.services': {
            ...
            'comercial_pic': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'other_services_blurb': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'other_services_pic': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'residential_blurb': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'residential_pic': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
