...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Index.affilation_pic1'
        db.add_column(u'pages_index', 'affilation_pic1',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Index.affilation_pic2'
        db.add_column(u'pages_index', 'affilation_pic2',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Index.affilation_pic3'
        db.add_column(u'pages_index', 'affilation_pic3',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Index.affilation_pic4'
        db.add_column(u'pages_index', 'affilation_pic4',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Index.affilation_pic5'
        db.add_column(u'pages_index', 'affilation_pic5',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Index.affilation_pic6'
        db.add_column(u'pages_index', 'affilation_pic6',
                      self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Index.affilation_pic1'
        db.delete_column(u'pages_index', 'affilation_pic1')

        # Deleting field 'Index.affilation_pic2'
        db.delete_column(u'pages_index', 'affilation_pic2')

        # Deleting field 'Index.affilation_pic3'
        db.delete_column(u'pages_index', 'affilation_pic3')

        # Deleting field 'Index.affilation_pic4'
        db.delete_column(u'pages_index', 'affilation_pic4')

        # Deleting field 'Index.affilation_pic5'
        db.delete_column(u'pages_index', 'affilation_pic5')

        # Deleting field 'Index.affilation_pic6'
        db.delete_column(u'pages_index', 'affilation_pic6')
