...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pages_our_people', (
            ...
            ('headline', self.gf('django.db.models.fields.CharField')(max_length=48, blank=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
        ...
        # Deleting field 'About.our_people_headline'
        db.delete_column(u'pages_about', 'our_people_headline')

        # Deleting field 'About.our_people_description'
        db.delete_column(u'pages_about', 'our_people_description')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'About.our_people_headline'
        db.add_column(u'pages_about', 'our_people_headline',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'About.our_people_description'
        db.add_column(u'pages_about', 'our_people_description',
