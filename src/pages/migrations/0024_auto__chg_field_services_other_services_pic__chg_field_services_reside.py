...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Services.other_services_pic'
        db.alter_column(u'pages_services', 'other_services_pic', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True))

        # Changing field 'Services.residential_pic'
        db.alter_column(u'pages_services', 'residential_pic', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True))

        # Changing field 'Services.comercial_pic'
        db.alter_column(u'pages_services', 'comercial_pic', self.gf('imagekit.models.fields.ProcessedImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Services.other_services_pic'
        db.alter_column(u'pages_services', 'other_services_pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Services.residential_pic'
        db.alter_column(u'pages_services', 'residential_pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Services.comercial_pic'
        db.alter_column(u'pages_services', 'comercial_pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
